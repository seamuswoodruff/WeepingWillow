...
const STOCKISTS = [
  {
    ...
    logo: '/images/stockist-morning-glory.webp',
  ...
  },
  {
    ...
    area: 'Portland, ME',
    tag: 'Restaurant',
    logo: '/images/stockist-street-and-co.webp',
    href: 'https://www.streetandcompany.net',
    overlayColor: 'rgba(20, 8, 4, 0.40)',
    bgColor: '#ffffff',
    bgSize: '80%',
    lat: 43.6563,
    lng: -70.2469,
  ...
  {
    name: 'Meet on the Street',
    area: 'Various, ME',
    tag: 'Food Truck',
    logo: '/images/stockist-meet-on-the-street.webp',
    href: 'https://www.meetonthestreetmaine.com',
    overlayColor: 'rgba(10, 10, 10, 0.60)',
    lat: null,
    lng: null,
  },
  {
    name: 'The Grateful Cup',
    area: 'Portland, ME',
    tag: 'Smoothies',
    logo: '/images/stockist-the-grateful-cup.webp',
    href: 'https://thegratefulcupmaine.com',
    overlayColor: 'rgba(40, 40, 80, 0.30)',
    bgColor: '#ffffff',
    bgSize: '72%',
    lat: 43.6712,
    lng: -70.2568,
...
export default function WhereToBuyPage() {
  const stockistSchema = {
    ...
    "@type": "ItemList",
    "name": "Honeysuckle Stockists",
    "itemListElement": STOCKISTS.filter(s => s.lat).map((s, i) => ({
      "@type": "ListItem",
      "position": i + 1,
      "item": {
        "@type": "LocalBusiness",
        "name": s.name,
        "address": { "@type": "PostalAddress", "addressLocality": s.area },
        "url": s.href,
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(stockistSchema) }}
      />
      {/* ═══════════════════════════════════════════════════════════
          1. PAGE HERO
      ═══════════════════════════════════════════════════════════ */}
            ...
            {STOCKISTS.map((s, i) => (
              ...
              >
                ...
                <div style={{
                  ...
                  background: (s as {bgColor?: string}).bgColor ?? 'transparent',
                  backgroundImage: `url(${s.logo})`,
                  backgroundSize: (s as {bgSize?: string}).bgSize ?? 'cover',
