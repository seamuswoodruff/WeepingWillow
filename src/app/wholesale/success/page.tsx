    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '28px' }}>
          <div style={{
            ...
            <svg width="24" height="18" viewBox="0 0 24 18" fill="none">
              <path d="M2 9 L9 16 L22 2" stroke="var(--color-green)" strokeWidth="1.75"
        ...
        <p style={{
          ...
          Thanks for your wholesale enquiry. We look forward to
          learning more about your business.
        </p>

        <Link href="/where-to-buy" style={{
